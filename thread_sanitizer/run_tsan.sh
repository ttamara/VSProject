...
# Modify .pro file to enable ThreadSanitizer
echo "QMAKE_CXXFLAGS += -fsanitize=thread" >> MrSnowman.pro
echo "QMAKE_LFLAGS += -fsanitize=thread" >> MrSnowman.pro
...
# Run your app with ThreadSanitizer
